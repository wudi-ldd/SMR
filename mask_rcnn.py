...
class MASK_RCNN(object):
    _defaults = {
        "model_path": 'logs/epoch004_loss1.838_val_loss1.925.h5',
        "classes_path": 'model_data/Nshape_classes.txt',
        "confidence": 0.5,
    ...
    def detect_image(self, image):
        ...
        drawed_image = visualize.display_instances(image[0], r['rois'], r['masks'], r['class_ids'],self.class_names,r['scores'])
