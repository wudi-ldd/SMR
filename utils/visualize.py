...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    for i in range(N):
        ...
        #     #xiugai
        #     score = "" if scores is not None else None
        ...
        # cv2.putText(masked_image, caption, (x3, y3), font, 1, (255, 255, 255), 2)
        ...
        for verts in contours:
            ...
            font = cv2.FONT_HERSHEY_SIMPLEX
            cv2.putText(masked_image, caption, (x3, y3), font, 0.6, (255, 255, 255), 2)
